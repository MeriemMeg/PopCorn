...
class RecyclerViewSeriesLieesAdapter(private val mContext: Context, private val dataList: ArrayList<Serie>?) : RecyclerView.Adapter<RecyclerViewSeriesLieesAdapter.ItemRowHolder>() {
    ...
    override fun onBindViewHolder(itemRowHolder: ItemRowHolder, i: Int) {
        ...
        itemRowHolder.itemTitle.text = "Séries Liées"

        val itemListDataAdapter = SectionListSeriesLieesAdapter(mContext, singleSectionItems)
