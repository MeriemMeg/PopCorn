...
class RecyclerViewChainesAdapter(private val mContext: Context, private val dataList: ArrayList<Chaine>?) : RecyclerView.Adapter<RecyclerViewChainesAdapter.ItemRowHolder>() {
    ...
    override fun onBindViewHolder(itemRowHolder: ItemRowHolder, i: Int) {
        ...
        itemRowHolder.itemTitle.text = "Diffusion"

        val itemListDataAdapter = SectionListChainesAdapter(mContext, singleSectionItems)
